...
export function HomeCta({ fallback }: { fallback: HomeCta }) {
  ...
  return (
    <section className="relative mx-4 mb-12 overflow-hidden rounded-3xl bg-brand-light text-white sm:mx-6">
      ...
      />
      <div className="relative mx-auto flex max-w-7xl 2xl:max-w-[1440px] flex-col items-start justify-between gap-5 px-4 py-10 sm:px-6 sm:py-12 md:flex-row md:items-center">
